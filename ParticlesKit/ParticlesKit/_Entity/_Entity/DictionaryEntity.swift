...
@objc open class DictionaryEntity: NSObject, ModelObjectProtocol, ParsingProtocol, JsonPersistable, DirtyProtocol {
    @objc open dynamic var data: [String: Any]?

    @objc public var dirty_time: Date? {
        get {
